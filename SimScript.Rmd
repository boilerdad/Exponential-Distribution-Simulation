...
g <- g + annotate("text",x=6,y=100,label = "Solid Line at mu", color = "black", cex = 4,hjust=0)
g <- g + annotate("text",x=6,y=95,label = "Dashed Line at mean", color = "black", cex = 4,hjust=0)
g <- g + annotate("text",x=6,y=90,label = "(These lines nearly overlap)", color = "black", cex = 4,hjust=0)
...
h <- h + annotate("text",x=6,y=100,label = "Solid Line at sigma", color = "black", cex = 4,hjust=0)
h <- h + annotate("text",x=6,y=95,label = "Dashed Line at St Dev", color = "black", cex = 4,hjust=0)
plot_grid(g,h)
...
Layering the upper and lower confidence intervals may provide some insight.
...
##### Dose at 0.50 mg/day
`r kable(f1, format = "html", table.attr = "style='width:60%;'") %>% kable_styling(bootstrap_options = "bordered", position = "left")`
...
##### Dose at 1.0 mg/day
`r kable(f2, format = "html", table.attr = "style='width:60%;'") %>% kable_styling(bootstrap_options = "bordered", position = "left")`
...
##### Dose at 2.0 mg/day
`r kable(f3, format = "html", table.attr = "style='width:60%;'") %>% kable_styling(bootstrap_options = "bordered", position = "left")`
...
`r kable(e2, format = "html", table.attr = "style='width:60%;'") %>% kable_styling(bootstrap_options = "bordered", position = "left")`
...
`r kable(e1, format = "html", table.attr = "style='width:60%;'") %>% kable_styling(bootstrap_options = "bordered", position = "left")`
...
### Conducting T-Tests on the Differences
...
ttt1[1,1] <- "Methods Compared at Dose 0.5 mg/day"
...
ttt1[2,1] <- "Methods Compared at Dose 1.0 mg/day"
...
ttt1[3,1] <- "Methods Compared at Dose 2.0 mg/day"
...
ttt2[1,1] <- "Dose compared: 0.5 to 1.0 mg/day, with Orange Juice delivery"
...
ttt2[2,1] <- "Dose compared: 0.5 to 2.0 mg/day, with Orange Juice delivery"
...
ttt2[3,1] <- "Dose compared: 1.0 to 2.0 mg/day, with Orange Juice delivery"
...
ttt2[4,1] <- "Dose compared: 0.5 to 1.0 mg/day, with Ascorbic Acid delivery"
...
ttt2[5,1] <- "Dose compared: 0.5 to 2.0 mg/day, with Ascorbic Acid delivery"
...
ttt2[6,1] <- "Dose compared: 1.0 to 2.0 mg/day, with Ascorbic Acid delivery"
...
#### Results of T-tests Comparing Delivery Method within Dose Amounts

The first set of analyses include the comparison of delivery method by dosing amount. The mean length of Odontoblasts are compared with dose held constant and delivery method compared. The following table summarises these results. 

`r kable(ttt1, format = "html", table.attr = "style='width:80%;'", digits = 3) %>% kable_styling(bootstrap_options = "bordered", position = "left")`
...
#### Results of T-tests Comparing Doseage pairs within Delivery Method

The second set of analyses include the comparison of doseage pairs by delivery method. The mean length of Odontoblasts are compared with delivery method held constant and pairs of doseage amounts compared (i.e., 0.5 to 1.0, 0.5 to 2.0, and 1.0 to 2.0). The following table summarises these results. 

`r kable(ttt2, format = "html", table.attr = "style='width:80%;'", digits = 3) %>% kable_styling(bootstrap_options = "bordered", position = "left")`
...
The of the confidence interval analysis and the t-test analysis are essentailly the same. As a result, it is reasonable to conclude that increasing doseage of both ascorbic acid and orange juice above a minimum amount is effective in increasing odontoblast length. At the highest dose, there is no indicated difference in the delivery method. 

When comparing the various doseage pairs, all appear to have a significant impact, regardless of delivery method. However the Bonferroni correction for Family-Wise Error Rate does call one effect into question.
